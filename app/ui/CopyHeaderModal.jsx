...
function CopyHeaderModal({ setModalShown, mockToCopyClipboard, setMockToCopyClipboard }) {

  const closeModal = () => {
    //close modal
    setModalShown(false)
    //mockToCopyClipboard back to default state
  ...
  {mockToCopyClipboard ? (
    <p className="whitespace-wrap break-words">{JSON.stringify(mockToCopyClipboard)}</p>
  ) : (
